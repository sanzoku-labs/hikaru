...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("border-b border-slate-200 bg-slate-100 dark:border-slate-800 dark:bg-slate-800", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-slate-200 bg-slate-100 font-medium dark:border-slate-800 dark:bg-slate-800 [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
